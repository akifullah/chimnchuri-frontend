        ...
        <section className="py-10 lg:py-20 ">
          <div className="group text-center max-w-xl mx-auto text-white grid justify-center text-5xl md:text-9xl space-y-4 font-bold uppercase">
            ...
            <div className="h-0 grid items-center overflow-hidden group-hover:h-[200] group-hover:md:h-[500] transition-all duration-500">
              <a href="#" className="hover:scale-125 hover:text-brand text-shadow-lg transition-all duration-500">Menu</a>
              <a href="#" className="hover:scale-125 hover:text-brand text-shadow-lg transition-all duration-500">Order</a>
              <a href="#" className="hover:scale-125 hover:text-brand text-shadow-lg transition-all duration-500">Team</a>
            </div>
          ...
          <section className="py-10 lg:py-20">
            <div className="max-w-xl mx-auto text-center  font-bold uppercase">
              ...
              <div className="flex flex-wrap items-center justify-center gap-5 font-bold text-md mt-5">
                <a href="#" className="text-white hover:text-brand transition-all duration-500">Home</a>
                <a href="#" className="text-white hover:text-brand transition-all duration-500">Menu</a>
                <a href="#" className="text-white hover:text-brand transition-all duration-500">Our Food</a>
