                ...
                <div className="max-w-3xl mx-auto bg-brand/10 border border-brand/20 rounded-[32px] p-8 md:p-14 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link href="/categories" className="px-8 py-4 bg-brand hover:bg-green-700 text-white rounded-xl font-bold transition-all shadow-xl shadow-brand/20 text-md w-full sm:w-auto uppercase tracking-wide">
                                Explore Menu
                            </Link>
