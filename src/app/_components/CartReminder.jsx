    ...
    return (
        ...
        >
            <button
                ...
                className={`w-full flex items-center shadow shadow-zinc-800/30 justify-between gap-3 sm:gap-4 hover:bg-brand bg-green-800 text-white px-3.5 sm:px-5 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl shadow-2xl shadow-brand/40 transition-all duration-300 cursor-pointer group ${pulse ? "scale-[1.03]" : "scale-100"}`}
            >
